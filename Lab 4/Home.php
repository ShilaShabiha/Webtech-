...
<fieldset>
		   <div> 
		      ...
		      <p ><h1 style="color: green">  Online  <sub style="color:black">Shopping </sub> <h1> </p> 
	    ...
	    <div>
		   ...
		   <p> <h1 align="left" > Welcome to <sub style="color:green" > Online <sup style="color:black">Shopping </sub> </p> <br> <br>
